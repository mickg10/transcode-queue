...
class Performers:
    def __init__(self, models: Path, confidence=.3, threads=4):
        cv2.setNumThreads(threads)
        self.net = cv2.dnn.readNet(str(models / "object_detection_yolox_2022nov.onnx"))
    ...
    def detect(self, frame):
        ...
        self.net.setInput(canvas.transpose(2, 0, 1)[None])
...
def stage_candidates(detections, *, maximum_head_y=.66, minimum_height=.13):
